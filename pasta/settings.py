...
class PastaUserSettings(UserSettingsContainer):
    def __init__(self):
        ...
        self.sate.add_option('num_cpus_spark', IntUserSetting(name='num_cpus_spark', default=0, min=0, max=None, short_name=None, help='The number of processing cores that you would like to assign to mafft when using Spark.  This number should not exceed the number of cores by executor. [default: 1]', subcategory='platform'))
        self.sate.add_option('num_partitions', IntUserSetting(name='num_partitions', default=0, min=0, max=None, short_name=None, help='The number of partitions to divide the alignment jobs with mafft when using Spark. This number should not exceed the number of executors.', subcategory='platform'))
